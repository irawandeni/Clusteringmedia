...
<body>
	...
	<form action="siswa_masuk.php" method="post">		
		<table>
		<div class="form-group">
           ...
           <input type="text" name="nama" class="form-control" placeholder=" Masukkan Nama" required/>
            ...
            <input type="text" name="jekel" class="form-control" placeholder="Masukan Jenis Kelamin" required/>
        </div>
			<div class="form-group">
            <label>Kelas:</label>
           <input type="int" name="kelas" class="form-control" placeholder=" Masukkan Kelas" required/>
        </div>
			<div class="form-group">
            <label>No Absen:</label>
            <input type="int" name="absen" class="form-control" placeholder="Masukan No Absen" required/>
        </div>
		</div>
			<div class="form-group">
            <label>Tempat Lahir:</label>
            <input type="text" name="tempat" class="form-control" placeholder="Masukan Tempat Lahir" required/>
        </div>
			<div class="form-group">
           ...
           <input type="date" name="tanggal" class="form-control" placeholder=" Masukkan Tanggal lahir" required/>
			...
			<div class="form-group">
            <label>Alamat:</label>
            <input type="int" name="alamat" class="form-control" placeholder="Masukan Alamat" required/>
        </div>
			<tr>
				<td></td>
