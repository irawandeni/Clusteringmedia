...
<body>
    <br>
    <h4>Grafik Pertanyaan 17 Guru mampu memahami beberapa faktor yang berpengaruh dalam menciptakan lingkungan belajar yang mendukung pbm</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select km1,COUNT(*) as 'total' from hasil GROUP by km1";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru msampu memahami beberapa faktor yang berpengaruh dalam menciptakan lingkungan belajar yang mendukung pbm',
