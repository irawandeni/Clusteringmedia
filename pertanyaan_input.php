...
<html>
<head>
	<title>Menampilkan data Pertanyaan </title>
...
<body>
	...
	<a href="pertanyaaninput.php">Lihat Semua Data</a>
 
	<br/>
	<h3>Input data Pertanyaan</h3>
	<form action="pertanyaan_masuk.php" method="post">		
		<table>
		<div class="form-group">
            <label>Nama Pertanyaan:</label>
           <input type="text" name="nama" class="form-control" placeholder=" Masukkan Nama Pertanyaan" required/>
        </div>
			<div class="form-group">
            <label>Kategori:</label>
            <input type="text" name="kategori" class="form-control" placeholder="Masukan Kategori Pertanyaan" required/>
        </div>
			<tr>
				<td></td>
