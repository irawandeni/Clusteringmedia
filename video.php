	   ...
	   <!-- /. NAV SIDE  -->
        <div id="page-wrapper">
          <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Video K-Means Clustering</h1>
...
<body>
<h2>Belajar Data Mining</h2>
<video width="720" height="auto" controls>
<source src="Belajar Data Mining - Algoritma K-Means Clustering.mp4" type="video/mp4" />
</video>

<h2>StatQuest K-means</h2>
<video width="720" height="auto" controls>
<source src="StatQuest_ K-means clustering.mp4" type="video/mp4" />
</video>
