	   ...
	   <!-- /. NAV SIDE  -->
        <div id="page-wrapper">
          <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Data Siswa SD Negeri Jatimulyo</h1>
...
echo "Data berhasil di hapus.";
	...
	?>
<br/> <form method="post" action="siswa_proses.php?hal=siswa">
...
<td><?php echo $data['alamat']; ?></td>
			...
			<td>
<a class="edit" href="siswa_edit.php?id=<?php echo $data['id'];  ?>">Edit</a> |
<a class="hapus" href="siswa_delete.php?id=<?php echo $data['id']; ?>">Hapus</a>					
			</td>
		</tr>
		<?php } ?>
	</table>
<a href="siswa_input.php?hal=siswa" class="btn btn-primary" role="button">Tambah Data Siswa</a>
</body>
</html>
	                   <!-- /. ROW  -->
