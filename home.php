...
?>        <!-- /. NAV SIDE  -->
        <div id="page-wrapper">
          <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">HALAMAN UTAMA</h1>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="main-box mb-red">
                            <a href="pengertianguru.php">
                            <i class="fa fa-file fa-5x"></i>
                                <h5>Pengertian Guru</h5>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="main-box mb-dull">
                            <a href="hitungclustering.php">
                            <i class="fa fa-question fa-5x"></i>
                                  <h5>Apa itu Clustering?</h5>
                            </a>
                        </div>
                    </div>
					...
					<div class="col-md-4">
                        <div class="main-box mb-red">
                            <a href="kmeansclustering.php">
                            <i class="fa fa-question fa-5x"></i>
                                <h5>Apa itu K-Means</h5>
                            </a>
                        </div>
                    </div>
