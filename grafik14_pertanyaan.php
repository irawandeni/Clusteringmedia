...
<body>
    <br>
    <h4>Grafik Pertanyaan 14  Guru memiliki kearifan dalam mengambil keputusan dan pengendalian diri dalam berbagai kondisi</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select si3,COUNT(*) as 'total' from hasil GROUP by si3";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'	Guru memiliki kearifan dalam mengambil keputusan dan pengendalian diri dalam berbagai kondisi',
