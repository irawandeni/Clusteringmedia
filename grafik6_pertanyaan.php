...
<body>
    <br>
    <h4>Grafik  Pertanyaan 6 Guru dapat menguasai berbagai model dan strategi pembelajaran dan juga menyampailan rencana pembelajaran dengan baik</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select mp6,COUNT(*) as 'total' from hasil GROUP by mp6";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru dapat menguasai berbagai model dan strategi pembelajaran dan juga menyampailan rencana pembelajaran dengan baik ',
