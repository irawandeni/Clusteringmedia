...
<form class="form-horizontal" name="login" id="form-login" method="post" action="log_proc.php" onSubmit="return validasi(this)">
	<div class="modal-body text-center">
		...
		<div class="input-prepend">
			<span class="add-on"><i class="icon-user"></i></span><select id="level" class="required input-large" name="level"><option value=''>- Level -</option><option value='Admin'>Admin</option><option value='User'>User</option></select>
		</div>
        <div class="row">
			&nbsp;
		</div>
