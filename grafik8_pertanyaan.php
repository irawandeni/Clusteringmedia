...
<body>
    <br>
    <h4>Grafik  Pertanyaan 8 Guru mampu menguasai bagaimana mengolah learning resources dari lingkungan hidup sehingga dapat dipergunakan untuk mendukung proses pembelajaran</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select ti2,COUNT(*) as 'total' from hasil GROUP by ti2";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'	Guru mampu menguasai bagaimana mengolah learning resources dari lingkungan hidup sehingga dapat dipergunakan untuk mendukung proses pembelajaran',
