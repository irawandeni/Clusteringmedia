...
<body>
    <br>
    <h4>Grafik  Pertanyaan 10 Guru mampu menguasai bagaimana menerapkan teknologi informasi dalam upaya meningkatkan efektifitas belajar anak</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select ti4,COUNT(*) as 'total' from hasil GROUP by ti4";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'	Guru mampu menguasai bagaimana menerapkan teknologi informasi dalam upaya meningkatkan efektifitas belajar anak',
