	   ...
	   <!-- /. NAV SIDE  -->
        <div id="page-wrapper">
          <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Data Hasil Perhitungan Responden</h1>
...
echo "Data berhasil di hapus.";
	...
	<a href='hitung_tampil.php' target='_blank'  class='btn btn-primary'> Hasil Rata Rata Kinerja Guru </a>

	<h3>Hasil Nilai Responden Untuk Guru Kelas 3 Atas Nama Cholisoh,S.Pd</h3>
...
echo "Data berhasil di hapus.";
	...
	<h3>Hasil Nilai Responden Untuk Guru Kelas 4 Atas Nama  Heri Sukamto Spd.SD</h3>
	<table border="1" class="table">
		<tr>
			<th>No</th>
...
echo "Data berhasil di hapus.";
	...
	<h3>Hasil Nilai Responden Untuk Guru Kelas 6  Atas Nama  Kuntowati Solikhah, Spd Sd</h3>
	<table border="1" class="table">
		<tr>
			<th>No</th>
...
echo "Data berhasil di hapus.";
	...
	<h3>Hasil Nilai Responden Untuk Guru Kelas 5 Atas Nama Listiyo Pangesti</h3>
	<table border="1" class="table">
		<tr>
			<th>No</th>
...
echo "Data berhasil di hapus.";
	...
	<h3>Hasil Nilai Responden Untuk Guru Kelas 1 Atas Nama Tri Nursih, A.Ma.Pd</h3>
	<table border="1" class="table">
		<tr>
			<th>No</th>
...
echo "Data berhasil di hapus.";
	...
	<h3>Hasil Nilai Responden Untuk Guru Kelas 2 Atas Nama  Ani Sukasri Endarwati.Spd</h3>
	<table border="1" class="table">
		<tr>
			<th>No</th>
...
echo "Data berhasil di hapus.";
	...
	<h3>Data Hasil Nilai Responden Untuk Guru PAI Atas Nama Winanti Khusumaning Rahayu S.Pd  I</h3>
	<table border="1" class="table">
		<tr>
			<th>No</th>
