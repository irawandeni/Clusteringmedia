...
<body>
    <br>
    <h4>Grafik  Pertanyaan 4 Guru memiliki metode penyampaian materi yang baik dan dapat membimbing anak bika menghadapi persoalan dalam pembelajaran</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select mp4,COUNT(*) as 'total' from hasil GROUP by mp4";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru memiliki metode penyampaian materi yang baik dan dapat membimbing anak bika menghadapi persoalan dalam pembelajaran',
