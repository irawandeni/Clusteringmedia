...
echo "Data berhasil di hapus.";
	...
	<a href='profesional.php' target='_blank'  class='btn btn-primary'> Hasil Rata Rata Kinerja Guru </a>

	<h3>Hasil Nilai Responden Pedagogik </h3>
	<table border="1" class="table">
		...
		<?php 
		include "config.php";
		$query_mysql = mysql_query("SELECT * FROM hasil")or die(mysql_error());
		$nomor = 1;
...
<td><?php echo $data['mp1']; ?></td>
<td><?php echo $data['mp2']; ?></td>
<td><?php echo $data['mp3']; ?></td>
<td><?php echo $data['mp4']; ?></td>
<td><?php echo $data['mp5']; ?></td>
<td><?php echo $data['mp6']; ?></td>
