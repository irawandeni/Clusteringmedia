...
<body>
    <br>
    <h4>Grafik  Pertanyaan 2 Guru dapat memahami potensi-potensi anak didik</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select mp2,COUNT(*) as 'total' from hasil GROUP by mp2";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru dapat memahami potensi-potensi anak didik',
