...
<body>
    <br>
    <h4>Grafik Pertanyaan 18 Guru dapat mengerti berbagai faktor sosial –cultural dan ekonomi yang berpengaruh terhadap proses pendidikan anak di sekolah</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select km2,COUNT(*) as 'total' from hasil GROUP by km2";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'	Guru dapat mengerti berbagai faktor sosial –cultural dan ekonomi yang berpengaruh terhadap proses pendidikan anak di sekolah',
