...
<body>
    <br>
    <h4>Grafik Pertanyaan 20 Guru dapat mengerti nilai –nilai dan norma –norma yang berlaku dan di junjung tinggi oleh masyarakat</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select km4,COUNT(*) as 'total' from hasil GROUP by km4";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru dapat mengerti nilai –nilai dan norma –norma yang berlaku dan di junjung tinggi oleh masyarakat',
