...
if($_GET[act]=="lihat"){
  ...
  $queryutama = mysql_query("SELECT  *  FROM kasus where idk='$_GET[id]'"); 
    ...
    while ($data = mysql_fetch_array($queryutama)) {
		 $c1=sqrt((pow(($data[kharga]-22.14285714),2))+(pow(($data[kmenu]-19),2))+(pow(($data[kfasilitas]-18.92857143),2))+(pow(($data[kjam]-19.21428571),2)));
		...
		echo"<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C$_GET[id]1 = √((($data[kharga]-22.14285714)^2)+(($data[kmenu]-19)^2)+(($data[kfasilitas]-18.92857143)^2)+(($data[kjam]-19.21428571)^2)) = $c1 </p>";
		echo"<p><b>Hitung jarak ID Kasus $_GET[id] terhadap cluster Kedua:</b></p>";
		echo"<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C$_GET[id]2 = √((($data[kharga]-25.47368421)^2)+(($data[kmenu]-21.42208)^2)+(($data[kfasilitas]-21.63157895)^2)+(($data[kjam]-21.89473684)^2)) = $c2</p>";
...
echo"<p><a href='interasi1.php' target='_blank'  class='btn btn-primary'> Interasi Selanjutnya</a></p>";
