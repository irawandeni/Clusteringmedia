...
echo "Data berhasil di hapus.";
	...
	<a href='sosial.php' target='_blank'  class='btn btn-primary'> Hasil Rata Rata Kinerja Guru </a>

	<h3>Hasil Nilai Responden Kepribadian </h3>
...
<td><?php echo $data['si1']; ?></td>
<td><?php echo $data['si2']; ?></td>
<td><?php echo $data['si3']; ?></td>
<td><?php echo $data['si4']; ?></td>
<td><?php echo $data['si5']; ?></td>
