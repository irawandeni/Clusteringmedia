...
<body>
    <br>
    <h4>Grafik Pertanyaan 15 Guru dapat memiliki rasa tanggung jawab yang kokoh dalam melakukan fungsinya sebagai guru</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select si4,COUNT(*) as 'total' from hasil GROUP by si4";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'	Guru dapat memiliki rasa tanggung jawab yang kokoh dalam melakukan fungsinya sebagai guru',
