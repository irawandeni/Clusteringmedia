...
<body>
    <br>
    <h4>Grafik  Pertanyaan 3 Guru dapat menguasai bahasa indonesia yang baik sebagai medium of instruction yang efektif</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select mp3,COUNT(*) as 'total' from hasil GROUP by mp3";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru dapat menguasai bahasa indonesia yang baik sebagai medium of instruction yang efektif',
