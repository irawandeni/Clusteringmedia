...
echo "Data berhasil di hapus.";
	...
	?>
<br/> <form method="post" action="pertanyaan_proses.php?hal=pertanyaan">
...
<input type="submit" name="submit" value="search"">
	...
	<table border="1" class="table">
		...
		<?php 
		include "config.php";
		$query_mysql = mysql_query("SELECT * FROM pertanyaan")or die(mysql_error());
		$nomor = 1;
...
<td><?php echo $data['kategori']; ?></td>
			...
			<td>
<a class="edit" href="pertanyaan_edit.php?id=<?php echo $data['id'];  ?>">Edit</a> |
<a class="hapus" href="pertanyaan_delete.php?id=<?php echo $data['id']; ?>">Hapus</a>										
			</td>
		</tr>
		<?php } ?>
	</table>
<a href="pertanyaan_input.php?hal=pertanyaan" class="btn btn-primary" role="button">Tambah Data Pertanyaan</a>
</body>
</html>
	                   <!-- /. ROW  -->
