...
<body>
    <br>
    <h4>Grafik  Pertanyaan 9 Guru mampu menguasai learning resources yang di perlukan dalam proses belajar mengajar</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select ti3,COUNT(*) as 'total' from hasil GROUP by ti3";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'	Guru mampu menguasai learning resources yang di perlukan dalam proses belajar mengajar',
