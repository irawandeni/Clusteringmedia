...
<body>
    <br>
    <h4>Grafik  Pertanyaan 7 Guru mampu menguasai bagaimana menerapkan Teknologi Informasi dalam upaya meningkatkan efektifitas anak</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select ti1,COUNT(*) as 'total' from hasil GROUP by ti1";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru mampu menguasai bagaimana menerapkan Teknologi Informasi dalam upaya meningkatkan efektifitas anak ',
