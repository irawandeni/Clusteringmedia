...
<body>
    <br>
    <h4>Grafik Pertanyaan 19 Guru mampu memahami pentingnya hubungan antara sekolah terhadap orang tua dan tokoh masyarakat yang berpengaruh terhadap proses pendidikan anak di Indonesia</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select km3,COUNT(*) as 'total' from hasil GROUP by km3";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru mampu memahami pentingnya hubungan antara sekolah terhadap orang tua dan tokoh masyarakat yang berpengaruh terhadap proses pendidikan anak di Indonesia',
