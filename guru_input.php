...
<html>
<head>
	<title>Menampilkan Data Guru </title>
...
<body>
	...
	<form action="guru_masuk.php" method="post">		
		<table>
		<div class="form-group">
            <label>NPSN:</label>
           <input type="int" name="npsn" class="form-control" placeholder=" Masukkan NPSN" required/>
        </div>
			<div class="form-group">
            ...
            <input type="text" name="ptk" class="form-control" placeholder="Masukan Nama PTK " required/>
        </div>
		</div>
			<div class="form-group">
            <label>Pangkat:</label>
            <input type="text" name="pangkat" class="form-control" placeholder="Masukan Pangkat/Gol" required/>
        </div>
		<div class="form-group">
            <label>NIP:</label>
            <input type="bigint" name="nip" class="form-control" placeholder="Masukan NIP" required/>
        </div>
			<div class="form-group">
            <label>Tugas:</label>
           <input type="text" name="tugas" class="form-control" placeholder=" Masukkan Tugas" required/>
            ...
            <input type="text" name="mapel" class="form-control" placeholder="Masukan Mapel Sertifikasi" required/>
        </div>
			<tr>
				<td></td>
