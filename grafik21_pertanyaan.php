...
<body>
    <br>
    <h4>Grafik Pertanyaan 21 Guru mampu memahami berbagai faktor yang berkontribusi dalam menciptakan lingkungan belajar yang mendukung Proses belajar Mengajar</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select km5,COUNT(*) as 'total' from hasil GROUP by km5";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru mampu memahami berbagai faktor yang berkontribusi dalam menciptakan lingkungan belajar yang mendukung Proses belajar Mengajar',
