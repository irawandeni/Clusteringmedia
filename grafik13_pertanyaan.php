...
<body>
    <br>
    <h4>Grafik Pertanyaan 13 Guru selalu adil dan memiliki kasih sayang kepada siswa tanpa membeda-bedakan</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select si2,COUNT(*) as 'total' from hasil GROUP by si2";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'	Guru selalu adil dan memiliki kasih sayang kepada siswa tanpa membeda-bedakan',
