...
<body>
    <br>
    <h4>Grafik  Pertanyaan 1 Guru dapat memahami Dengan baik ciri-ciri peserta didik</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select mp1,COUNT(*) as 'total' from hasil GROUP by mp1";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru dapat memahami Dengan baik ciri-ciri peserta didik ',
