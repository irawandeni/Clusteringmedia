...
?> 
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Hasil Clustering Interasi 3</h1>
...
if($_GET[act]=="lihat"){
  ...
  $queryutama = mysql_query("SELECT  *  FROM kasus where idk='$_GET[id]'"); 
    ...
    while ($data = mysql_fetch_array($queryutama)) {
		 $c1=sqrt((pow(($data[kharga]-22.14984),2))+(pow(($data[kmenu]-19.26032),2))+(pow(($data[kfasilitas]-19.16222),2))+(pow(($data[kjam]-19.22063),2)));
		 $c2=sqrt((pow(($data[kharga]-25.19912),2))+(pow(($data[kmenu]-21.42208),2))+(pow(($data[kfasilitas]-21.45716),2))+(pow(($data[kjam]-21.68816),2)));
		...
		echo"<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C$_GET[id]1 = √((($data[kharga]-22.14984)^2)+(($data[kmenu]-19.26032)^2)+(($data[kfasilitas]-19.16222)^2)+(($data[kjam]-19.22063)^2)) = $c1 </p>";
		echo"<p><b>Hitung jarak ID Kasus $_GET[id] terhadap cluster Kedua:</b></p>";
		echo"<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C$_GET[id]2 = √((($data[kharga]-25.19912)^2)+(($data[kmenu]-21.42208)^2)+(($data[kfasilitas]-21.45716)^2)+(($data[kjam]-21.68816)^2)) = $c2</p>";
