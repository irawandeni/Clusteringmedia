	   ...
	   <!-- /. NAV SIDE  -->
        <div id="page-wrapper">
          <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Data Hasil Rata-Rata Kinerja Guru</h1>
...
echo "Data berhasil di hapus.";
	...
	<h3>Data Hasil Rata-Rata Kinerja Guru</h3>
	<table border="1" class="table">
		...
		<?php 
		include "config.php";
		$query_mysql = mysql_query("SELECT * FROM kasus")or die(mysql_error());
		$nomor = 1;
