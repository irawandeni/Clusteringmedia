...
<body>
    <br>
    <h4>Grafik  Pertanyaan 5 Guru memberikan ulangan/ujian sesuai materi yang diajarkan</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select mp5,COUNT(*) as 'total' from hasil GROUP by mp5";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru memberikan ulangan/ujian sesuai materi yang diajarkan ',
