...
<body>
	...
	<a href="admin_tampil.php">Lihat Semua Data</a>
	...
	<form action="admin_update.php" method="post">		
		...
		<div class="form-group">
            <label>Phone:</label>
			<input type="number" name="phone" class="form-control" value="<?php echo $data['phone']; ?>" placeholder="Masukan Phone" required />
        </div>
		<div class="form-group">
            <label>Email:</label>
