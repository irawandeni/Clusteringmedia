...
<body>
    <br>
    <h4>Grafik Pertanyaan 16 Guru memberikan pujian terhadap peserta didik yang dapat menyelesaikan tugas tepat waktu</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select si5,COUNT(*) as 'total' from hasil GROUP by si5";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Guru memberikan pujian terhadap peserta didik yang dapat menyelesaikan tugas tepat waktu	',
