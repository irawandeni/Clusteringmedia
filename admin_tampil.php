...
echo "Data berhasil di hapus.";
	...
	?>
<br/> <form method="post" action="admin_proses.php?hal=admin">
<input type="text" name="search" placeholder="cari disini">
<input type="submit" name="submit" value="search"">
</form>

	<h3>Data Admin dan User</h3>
...
<td><?php echo $data['level']; ?></td>
			<td>
<a class="edit" href="admin_edit.php?id=<?php echo $data['id'];  ?>">Edit</a> |
<a class="hapus" href="admin_delete.php?id=<?php echo $data['id']; ?>">Hapus</a>					
			</td>
		</tr>
		<?php } ?>
	</table>
<a href="admin_create.php?hal=admin" class="btn btn-primary" role="button">Tambah Data Admin</a>
</body>
</html>
	         <!-- /. ROW  -->
