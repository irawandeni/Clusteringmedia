	   ...
	   <!-- /. NAV SIDE  -->
        <div id="page-wrapper">
          <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Data Siswa SDN Jatimulyo</h1>
...
<body>
	...
	<a href="siswa_tampil.php">Lihat Semua Data</a>
	...
	<form action="siswa_update.php" method="post">		
		<table>
           ...
           <input type="text" name="nama" class="form-control" value="<?php echo $data['nama']; ?>" placeholder="Masukan Nama" required />
            ...
            <input type="text" name="jekel" class="form-control" value="<?php echo $data['jekel']; ?>" placeholder="Masukan Jenis Kelamin" required />

        </div>
			<div class="form-group">
            <label>Kelas:</label>
            <input type="int" name="kelas" class="form-control" value="<?php echo $data['kelas']; ?>" placeholder="Masukan Kelas" required />
        </div>	
		
		<div class="form-group">
            <label>No Absen:</label>
			<input type="int" name="absen" class="form-control" value="<?php echo $data['absen']; ?>" placeholder="Masukan No Absen" required />
        </div>
		<div class="form-group">
            <label>Tempat Lahir:</label>
            <input type="text" name="tempat" class="form-control" value="<?php echo $data['tempat']; ?>" placeholder="Masukan Tempat Lahir" required />
        </div>
		<div class="form-group">
            <label>Tangal Lahir:</label>
            <input type="date" name="tanggal" class="form-control" value="<?php echo $data['tanggal']; ?>" placeholder="Masukan Tanggal Lahir" required />
        </div>
		<div class="form-group">
            <label>Alamat:</label>
