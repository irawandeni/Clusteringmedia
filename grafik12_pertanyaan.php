...
<body>
    <br>
    <h4>Grafik Pertanyaan 12 Guru memiliki Keteladanan dalam bersikap dan berpelilaku</h4>
    ...
    $jumlah=null;
    //Query SQL
    $sql="select si1,COUNT(*) as 'total' from hasil GROUP by si1";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'	Guru memiliki Keteladanan dalam bersikap dan berpelilaku',
